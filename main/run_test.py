...
class RunTest:
    ...
    def Login(self):
        ...
        import requests
        res = requests.post(url, data='account=18510361911&password=2569D419BFEA999FF13FD1F7F4498B89&role_type=1',cookies=cookies, headers=headers, verify=False).json()
